...
public  class AppliToolsDemo {
  ...
  public static void main(String[] args) {
    ...
    WebDriver innerDriver = new SafariDriver();  // Open a  browser.
  ...
  static private void test01(WebDriver innerDriver, Eyes eyes, RectangleSize viewportSize) {
    ...
    try {
      ...
      driver.findElement(By.id("name")).sendKeys("AMAN"); //enter the name
  ...
  static private void setup(Eyes eyes) {
    String apiKey = "mgSPpnrbkFfVee2GDtH0EMDelO3wTs56wZYb2i9M950110 ";
